                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-gray-50 dark:bg-zinc-800 p-4 border-2 border-gray-200 dark:border-zinc-700 rounded-lg">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <button
                            ...
                            className={`p-3 border-3 rounded-lg font-bold text-xs uppercase transition-all flex flex-col items-center gap-1 ${resumeSource === 'upload'
                          ...
                          <button
                            ...
                            className={`p-3 border-3 rounded-lg font-bold text-xs uppercase transition-all flex flex-col items-center gap-1 ${resumeSource === 'profile'
                      ...
                      {resumeSource === 'upload' && (
                        <div className="animate-in fade-in slide-in-from-top-2 duration-200">
                          <div className={`border-4 border-dashed p-6 text-center transition-colors rounded-lg ${isProfileIncomplete
