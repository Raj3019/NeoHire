                ...
                {isRecruiterMode ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end">
                        ...
                        <div className="bg-white dark:bg-zinc-800 border-4 border-neo-black dark:border-white p-8 shadow-neo dark:shadow-[4px_4px_0px_0px_#ffffff] h-auto flex flex-col relative group hover:-translate-y-2 transition-transform">
                            ...
                            <div className="flex items-baseline gap-3 mb-6">
                                ...
                                <span className="text-4xl font-black text-neo-black/40 dark:text-white/40 line-through decoration-4 decoration-neo-red transform -rotate-3">$20</span>
                            </div>
                            <ul className="font-mono text-sm space-y-4 mb-8 flex-1 font-bold dark:text-gray-300">
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> 5 Job posting monthly </li>
                        ...
                        <div className="bg-neo-black dark:bg-zinc-900 text-white border-4 border-neo-black dark:border-white p-8 shadow-neo-xl dark:shadow-[8px_8px_0px_0px_#ffffff] h-auto md:h-[36rem] flex flex-col relative z-10 transform scale-105">
                            ...
                            <div className="flex items-baseline gap-4 mb-8">
                                <p className="text-8xl font-black tracking-tighter">$69</p>
                                <span className="text-5xl font-black text-white/50 line-through decoration-4 decoration-neo-orange transform -rotate-2">$99</span>
                            </div>
                            <ul className="font-mono text-base space-y-5 mb-8 flex-1 font-bold">
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> 30 job posting monthly</li>
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> Recuiter radar</li>
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> Early access to new features</li>
                        ...
                        {/* Tier 3 - Coming Soon */}
                        <div className="bg-gray-100 dark:bg-zinc-800 border-4 border-gray-300 dark:border-gray-600 p-8 shadow-[4px_4px_0px_0px_#d1d5db] dark:shadow-[4px_4px_0px_0px_#4b5563] h-auto flex flex-col relative cursor-not-allowed">
                            <div className="absolute top-0 inset-x-0 -mt-4 flex justify-center">
                                <span className="bg-gray-500 text-white font-black uppercase px-4 py-1 border-2 border-gray-600 text-sm">COMING SOON</span>
                            </div>
                            <h3 className="text-4xl font-black uppercase mb-2 text-gray-500 dark:text-gray-400">EMPIRE</h3>
                            <p className="text-7xl font-black mb-6 text-gray-500 dark:text-gray-400">$999</p>
                            <ul className="font-mono text-sm space-y-4 mb-8 flex-1 font-bold text-gray-400 dark:text-gray-500">
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> Coming Soon</li>
                            ...
                            <button disabled className="w-full border-4 border-gray-400 bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400 py-4 text-xl font-black cursor-not-allowed">CONTACT SALES</button>
                        </div>
                    </div>
                ) : (
                    /* CANDIDATE PRICING */
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end">
                        ...
                        <div className="bg-white dark:bg-zinc-800 border-4 border-neo-black dark:border-white p-8 shadow-neo dark:shadow-[4px_4px_0px_0px_#ffffff] h-auto flex flex-col relative group hover:-translate-y-2 transition-transform">
                            ...
                            <ul className="font-mono text-sm space-y-4 mb-8 flex-1 font-bold dark:text-gray-300">
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> 2 Daily job apply</li>
                        ...
                        <div className="bg-neo-black dark:bg-zinc-900 text-white border-4 border-neo-black dark:border-white p-8 shadow-neo-xl dark:shadow-[8px_8px_0px_0px_#ffffff] h-auto md:h-[36rem] flex flex-col relative z-10 transform scale-105">
                            ...
                            <div className="flex items-baseline gap-4 mb-8">
                                <p className="text-8xl font-black tracking-tighter">$19</p>
                                <span className="text-5xl font-black text-white/50 line-through decoration-4 decoration-neo-yellow transform -rotate-2">$25</span>
                            </div>
                            <ul className="font-mono text-base space-y-5 mb-8 flex-1 font-bold">
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> 10 Daily job apply</li>
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> Auto-Apply Bot</li>
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> Resume Improvement</li>
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> Early access to new features</li>
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> Priority Support</li>
                            </ul>
                        ...
                        <div className="bg-gray-100 dark:bg-zinc-800 border-4 border-gray-300 dark:border-gray-600 p-8 shadow-[4px_4px_0px_0px_#d1d5db] dark:shadow-[4px_4px_0px_0px_#4b5563] h-auto flex flex-col relative cursor-not-allowed">
                            ...
                            <h3 className="text-4xl font-black uppercase mb-2 text-gray-500 dark:text-gray-400">GOD</h3>
                            <p className="text-7xl font-black mb-6 text-gray-500 dark:text-gray-400">$49</p>
                            <ul className="font-mono text-sm space-y-4 mb-8 flex-1 font-bold text-gray-400 dark:text-gray-500">
                                <li className="flex items-center"><span className="mr-3 text-2xl">✓</span> Coming Soon</li>
                            ...
                            <button disabled className="w-full border-4 border-gray-400 bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400 py-4 text-xl font-black cursor-not-allowed">GET HELP</button>
                        </div>
                    </div>
                )}
            </section>
